...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Arenas / Create </h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('arenas.store') }}" method="POST">
                ...
                <div class="well well-sm">
                    ...
                    <a class="btn btn-link pull-right" href="{{ route('arenas.index') }}"><i class="glyphicon glyphicon-backward"></i> Back</a>
                </div>
            </form>
